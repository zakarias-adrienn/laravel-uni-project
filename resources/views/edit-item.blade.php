...
@section('content')
    <div class="container">
        <h3>Modify item</h3>
        <form action="{{ route('modify.item', ['id' => $item->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            id="name" name="name" value="{{ old('name') ? old('name') : $item->name }} ">
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            id="description" name="description">{{ old('description') ? old('description') : $item->description }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            id="price" name="price" value="{{ old('price') ? old('price') : $item->price }}" step="0.01">
                            @if ($errors->has('price'))
                                <div class="invalid-feedback">
                    ...
                    @forelse($categories as $category)
                        <div class="form-check">
                            ...
                            name="categories[]" @if (in_array($category->id, $category_ids)) checked @endif>
